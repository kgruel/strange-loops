...
# _find_local_vertex — moved to commands/resolve.py, re-exported above
...
# _warn_missing_fold_key through _resolve_vertex_for_dispatch
# moved to commands/resolve.py, re-exported above
