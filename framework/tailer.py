...
The inverse of FileWriter. FileWriter is a consumer that appends events to a
JSONL file. Tailer is a source that reads events from a JSONL file.
...
(Projection, Stream, EventStore, whatever).
"""
