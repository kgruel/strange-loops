...
Stream is the center of the framework's event routing. EventStore, Projection,
and other consumers are just taps on a Stream — not the other way around.

No operator chains. No backpressure. No main loop ownership.
Sources are just async functions that call stream.emit().
"""
