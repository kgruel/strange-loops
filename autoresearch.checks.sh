...
if errors:
    print(f'WARNING: {len(errors)} tests without explicit assertions:')
    for e in errors:
        print(f'  {e}')
else:
    print('All atoms tests have assertions.')
"
