"""Golden integration test for the viewport.py demo.

Exercises: Viewport windowing via vslice, clamping to max_offset, and
cursor-follow via scroll_into_view() across zoom levels.
"""
...
_spec = importlib.util.spec_from_file_location(
    "_demo_viewport",
    _PROJECT / "demos" / "patterns" / "viewport.py",
)
...
def test_viewport_demo(golden, zoom):
    data = _fetch()
