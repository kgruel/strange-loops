...
facts provides reference emitters (`PlainEmitter`, `JsonEmitter`) as **working examples of the protocol**, not as reusable building blocks for all use cases. For Rich terminal output and composition utilities, see ev-toolkit.
