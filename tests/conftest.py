"""Pytest plugin for golden file testing.

--update-goldens rewrites expected output files so git diff shows the change.
Missing files are always written (first run bootstraps).
"""
